...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#021631] text-white pt-12 sm:pt-20 pb-6 sm:pb-8 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8 mb-10 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4 text-sm text-white/70">
              <li><Link to="/" className="hover:text-[#fcbc17] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#fcbc17] rounded-full" /> Início</Link></li>
              <li><Link to="/estoque" className="hover:text-[#fcbc17] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#fcbc17] rounded-full" /> Estoque</Link></li>
              <li><a href="#" className="hover:text-[#fcbc17] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#fcbc17] rounded-full" /> Financiamento</a></li>
              <li><a href="#" className="hover:text-[#fcbc17] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#fcbc17] rounded-full" /> Mentoria</a></li>
              <li><a href="#" className="hover:text-[#fcbc17] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#fcbc17] rounded-full" /> Sobre a Empresa</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 sm:space-y-5 text-sm text-white/70">
              <li className="flex items-center gap-3 sm:gap-4 group">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[#fcbc17]/10 transition-colors shrink-0">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href={settings.instagramUrl} className="flex items-center gap-3 sm:gap-4 group bg-white/5 p-2.5 sm:p-3 rounded-lg hover:bg-white/10 transition-colors border border-transparent hover:border-white/10">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#010e20] flex items-center justify-center group-hover:bg-[#fcbc17] transition-colors shrink-0">
